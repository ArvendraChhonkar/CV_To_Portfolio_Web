...
Basic Usage
Upload: Navigate to the upload route and select a .pdf or .docx file.

Processing: The application saves the file to the /uploaded directory. app.js triggers routes/CV_Process/NLP_Pipeline/NLP_1.py via a child process.

NER Extraction: NLP_1.py parses the text and identifies entities.

Generation: The system merges the extracted data into a selected template from routes/CV_Process/NLP_Pipeline/HTML_Templates.

View: The final portfolio is saved to public/portfolios/ and can be accessed via the browser.
